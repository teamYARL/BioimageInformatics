...
small background region(a big and bright region background may lead to zero significent 
local minumimum) as information needed for local minimums detection. 
